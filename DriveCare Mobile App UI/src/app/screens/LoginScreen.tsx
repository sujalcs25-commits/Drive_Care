    ...
    <MobileLayout showBottomNav={false}>
      <div className="h-full flex flex-col p-6">
        ...
        <div className="flex flex-col items-center pt-12 pb-8">
          <div className="bg-primary rounded-2xl p-6 mb-4 shadow-lg">
        ...
        <div className="flex-1 flex items-center justify-center mb-8">
          <div className="w-64 h-48 bg-muted rounded-2xl flex items-center justify-center border-2 border-border">
            <Car className="w-32 h-32 text-primary/20" strokeWidth={1} />
          </div>
        </div>
